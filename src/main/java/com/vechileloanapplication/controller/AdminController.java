...
public class AdminController 
{
    ...
    //ADDING AN ADMIN     
    @PostMapping("/admin")
    public ResponseEntity<AdminEntity> adminRegister(@Validated @RequestBody AdminEntity admin) throws RecordNotFoundException
    {
    ...
    //UPDATING AN ADMIN
    @PutMapping("/admin​​")
    public ResponseEntity<List<AdminEntity>> updateAdmin(@Validated @RequestBody AdminEntity admin) throws RecordNotFoundException
    {
